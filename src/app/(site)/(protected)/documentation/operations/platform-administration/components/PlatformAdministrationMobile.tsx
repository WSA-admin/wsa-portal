...
export default function PlatformAdministrationMobile() {
  const [activeSection, setActiveSection] = useState<'overview' | 'access' | 'security' | 'users' | 'support' | 'maintenance' | 'resources'>('overview');

  const buttonClass = "flex-1 py-3 px-2 text-sm font-medium rounded transition-colors duration-200";
  const getButtonStyle = (section: string) => {
    const isActive = activeSection === section;
    switch (section) {
      case 'overview':
        return `${buttonClass} ${isActive ? 'bg-[#2592D0] text-white' : 'bg-white text-[#2592D0] border border-[#2592D0]'}`;
      case 'access':
        return `${buttonClass} ${isActive ? 'bg-[#702083] text-white' : 'bg-white text-[#702083] border border-[#702083]'}`;
      case 'security':
        return `${buttonClass} ${isActive ? 'bg-[#012E55] text-white' : 'bg-white text-[#012E55] border border-[#012E55]'}`;
      case 'users':
        return `${buttonClass} ${isActive ? 'bg-[#FBBB02] text-black' : 'bg-white text-[#FBBB02] border border-[#FBBB02]'}`;
      case 'support':
        return `${buttonClass} ${isActive ? 'bg-[#EF7B02] text-white' : 'bg-white text-[#EF7B02] border border-[#EF7B02]'}`;
      case 'maintenance':
        return `${buttonClass} ${isActive ? 'bg-[#2592D0] text-white' : 'bg-white text-[#2592D0] border border-[#2592D0]'}`;
      case 'resources':
        return `${buttonClass} ${isActive ? 'bg-[#702083] text-white' : 'bg-white text-[#702083] border border-[#702083]'}`;
  ...
  return (
    <Section orientation="vertical" positioning="start" spacing="lg" className="p-4">
      ...
      <div className="grid grid-cols-2 gap-2 mb-6">
        <button onClick={() => setActiveSection('overview')} className={getButtonStyle('overview')}>
          Overview
        </button>
        <button onClick={() => setActiveSection('access')} className={getButtonStyle('access')}>
          Access
        </button>
        <button onClick={() => setActiveSection('security')} className={getButtonStyle('security')}>
          Security
        </button>
        <button onClick={() => setActiveSection('users')} className={getButtonStyle('users')}>
          Users
        </button>
        <button onClick={() => setActiveSection('support')} className={getButtonStyle('support')}>
          Support
        </button>
        <button onClick={() => setActiveSection('maintenance')} className={getButtonStyle('maintenance')}>
          Maintenance
        </button>
      </div>

      <div className="mb-6">
        <button onClick={() => setActiveSection('resources')} className={`w-full ${getButtonStyle('resources')}`}>
          Resources
        </button>
      </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded p-3">
                  ...
                  <div className="text-sm space-y-1">
                    <p><strong>Primary:</strong> Chuchi Soriano</p>
                    <p><strong>Backup:</strong> Daniel Ohaegbu</p>
                    <p><strong>Users:</strong> <span className="bg-green-100 text-green-800 px-2 py-1 rounded text-xs">5 Active</span></p>
                    <p><strong>Requests:</strong> <a href="mailto:chuchi@worksourcealliance.ca" className="text-[#2592D0] hover:underline">chuchi@worksourcealliance.ca</a></p>
                  </div>
                </div>
                ...
                <div className="border border-gray-200 rounded p-3">
                  ...
                  <div className="text-sm space-y-1">
                    <p><strong>Primary:</strong> Chuchi Soriano</p>
                    <p><strong>Backup:</strong> Tanguy Merrien</p>
                    <p><strong>Users:</strong> <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-xs">50+ Students</span></p>
                    <p><strong>Requests:</strong> <a href="mailto:chuchi@worksourcealliance.ca" className="text-[#2592D0] hover:underline">chuchi@worksourcealliance.ca</a></p>
                  </div>
                </div>
                ...
                <div className="border border-gray-200 rounded p-3">
                  ...
                  <div className="text-sm space-y-1">
                    <p><strong>Primary:</strong> Daniel Ohaegbu</p>
                    <p><strong>Backup:</strong> Chuchi Soriano</p>
                    <p><strong>Users:</strong> <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-xs">8 Staff</span></p>
                    <p><strong>Requests:</strong> <a href="mailto:daniel@worksourcealliance.ca" className="text-[#2592D0] hover:underline">daniel@worksourcealliance.ca</a></p>
                  </div>
                </div>
                ...
                <div className="border border-gray-200 rounded p-3">
                  ...
                  <div className="text-sm space-y-1">
                    <p><strong>Primary:</strong> Melvis O. Onoriode</p>
                    <p><strong>Backup:</strong> Chuchi Soriano</p>
                    <p><strong>Users:</strong> <span className="bg-orange-100 text-orange-800 px-2 py-1 rounded text-xs">Multi-platform</span></p>
                    <p><strong>Requests:</strong> <a href="mailto:melvis@worksourcealliance.ca" className="text-[#2592D0] hover:underline">melvis@worksourcealliance.ca</a></p>
                  </div>
                </div>
                ...
                <div className="border border-gray-200 rounded p-3">
                  ...
                  <div className="text-sm space-y-1">
                    <p><strong>Primary:</strong> Chuchi Soriano</p>
                    <p><strong>Backup:</strong> Daniel Ohaegbu</p>
                    <p><strong>Users:</strong> <span className="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs">Team Access</span></p>
                    <p><strong>Requests:</strong> <a href="mailto:chuchi@worksourcealliance.ca" className="text-[#2592D0] hover:underline">chuchi@worksourcealliance.ca</a></p>
                  </div>
                </div>
              </div>
