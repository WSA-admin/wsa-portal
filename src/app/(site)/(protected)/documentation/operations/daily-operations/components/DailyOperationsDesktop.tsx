...
export default function DailyOperationsDesktop() {
  return (
        ...
        <Card variant="white">
          <Section orientation="vertical" positioning="start" spacing="sm">
            ...
            <Section orientation="vertical" positioning="start" spacing="md">
              <Section orientation="horizontal" positioning="start" spacing="sm" className="border-l-4 border-[#2592D0] pl-4">
                ...
                <Section orientation="vertical" positioning="start" spacing="sm" fill>
                  ...
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Actions:</span> Log inquiry in CRM, send acknowledgment email, schedule initial consultation</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Timeline:</span> Response within 24 hours</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Responsible:</span> Rita Olfi (Job Placement Coordinator)</Text>
                  </Section>
                </Section>
              </Section>

              <Section orientation="horizontal" positioning="start" spacing="sm" className="border-l-4 border-[#702083] pl-4">
                ...
                <Section orientation="vertical" positioning="start" spacing="sm" fill>
                  ...
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Tools:</span> Standardized intake forms, skills assessment questionnaire</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Duration:</span> 45-60 minutes virtual or in-person meeting</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Outcome:</span> Client profile created in CRM with detailed assessment data</Text>
                  </Section>
                </Section>
              </Section>

              <Section orientation="horizontal" positioning="start" spacing="sm" className="border-l-4 border-[#FBBB02] pl-4">
                ...
                <Section orientation="vertical" positioning="start" spacing="sm" fill>
                  ...
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Options:</span> PeerPals (free), Transitions (paid), Easy Learn (free), Graduate Mentorship</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Criteria:</span> Client goals, experience level, availability, financial situation</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Decision:</span> Collaborative discussion with client preferences</Text>
                  </Section>
                </Section>
              </Section>

              <Section orientation="horizontal" positioning="start" spacing="sm" className="border-l-4 border-[#EF7B02] pl-4">
                ...
                <Section orientation="vertical" positioning="start" spacing="sm" fill>
                  ...
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Documents:</span> Program agreement, privacy consent, emergency contact information</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Setup:</span> Platform access credentials, program materials distribution</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Payment:</span> Process fees for paid programs (Transitions)</Text>
                  </Section>
                </Section>
              </Section>

              <Section orientation="horizontal" positioning="start" spacing="sm" className="border-l-4 border-[#012E55] pl-4">
                ...
                <Section orientation="vertical" positioning="start" spacing="sm" fill>
                  ...
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Orientation:</span> Program introduction session, expectations setting</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Scheduling:</span> Regular check-ins, workshop sessions, mentorship meetings</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Resources:</span> Access to Easy Learn platform, networking events</Text>
                  </Section>
                </Section>
              </Section>
              ...
              <Section orientation="horizontal" positioning="start" spacing="sm" className="border-l-4 border-[#2592D0] pl-4">
                ...
                <Section orientation="vertical" positioning="start" spacing="sm" fill>
                  ...
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Frequency:</span> Bi-weekly check-ins, monthly progress reviews</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Metrics:</span> Skill development, job applications, interview success, employment outcomes</Text>
                    <Text variant="small" customColor="#9CA3AF"><span className="font-semibold">Support:</span> Ongoing coaching, problem-solving, program adjustments</Text>
                  </Section>
                </Section>
              </Section>
            </Section>
              ...
              <Section orientation="vertical" positioning="start" spacing="md">
                <Card variant="white" className="border-l-4 border-red-400">
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    ...
                    <Section orientation="vertical" positioning="start" spacing="sm">
                      <Text variant="small" customColor="#6B7280">• Client emergency situations</Text>
                      <Text variant="small" customColor="#6B7280">• System outages or technical issues</Text>
                      <Text variant="small" customColor="#6B7280">• Media inquiries or PR matters</Text>
                      <Text variant="small" customColor="#6B7280">• Executive requests</Text>
                    </Section>
                  </Section>
                </Card>
                ...
                <Card variant="white" className="border-l-4 border-orange-400">
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    ...
                    <Section orientation="vertical" positioning="start" spacing="sm">
                      <Text variant="small" customColor="#6B7280">• New client onboarding</Text>
                      <Text variant="small" customColor="#6B7280">• Employer partnership opportunities</Text>
                      <Text variant="small" customColor="#6B7280">• Program delivery issues</Text>
                      <Text variant="small" customColor="#6B7280">• Team coordination needs</Text>
                    </Section>
                  </Section>
                </Card>
                ...
                <Card variant="white" className="border-l-4 border-yellow-400">
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    ...
                    <Section orientation="vertical" positioning="start" spacing="sm">
                      <Text variant="small" customColor="#6B7280">• Client progress reviews</Text>
                      <Text variant="small" customColor="#6B7280">• Documentation updates</Text>
                      <Text variant="small" customColor="#6B7280">• Marketing material development</Text>
                      <Text variant="small" customColor="#6B7280">• Process improvements</Text>
                    </Section>
                  </Section>
                </Card>
              </Section>
              ...
              <Section orientation="vertical" positioning="start" spacing="md">
                <Card variant="white">
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    ...
                    <Section orientation="vertical" positioning="start" spacing="sm">
                      <Text variant="small" customColor="#6B7280">• High-focus tasks and client consultations</Text>
                      <Text variant="small" customColor="#6B7280">• New client onboarding sessions</Text>
                      <Text variant="small" customColor="#6B7280">• Team coordination meetings</Text>
                    </Section>
                  </Section>
                </Card>
                ...
                <Card variant="white">
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    ...
                    <Section orientation="vertical" positioning="start" spacing="sm">
                      <Text variant="small" customColor="#6B7280">• Administrative tasks and documentation</Text>
                      <Text variant="small" customColor="#6B7280">• Client follow-ups and check-ins</Text>
                      <Text variant="small" customColor="#6B7280">• Program delivery activities</Text>
                    </Section>
                  </Section>
                </Card>
                ...
                <Card variant="white">
                  <Section orientation="vertical" positioning="start" spacing="sm">
                    ...
                    <Section orientation="vertical" positioning="start" spacing="sm">
                      <Text variant="small" customColor="#6B7280">• Daily wrap-up and planning</Text>
                      <Text variant="small" customColor="#6B7280">• Progress reporting and updates</Text>
                      <Text variant="small" customColor="#6B7280">• Next-day preparation</Text>
                    </Section>
                  </Section>
                </Card>
              </Section>
